...
<link rel="stylesheet"
	href="<c:url value='/template/admin/ajax/jquery-ui.css'/>" />	
<!-- <link rel="stylesheet"
	href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css"> -->
<link rel="stylesheet"
	href="<c:url value='/template/admin/code-jquery/jquery-ui.css'/>" />	
<!-- <script
...
<script
	src="<c:url value='/template/admin/code-jquery/jquery-ui.js'/>"></script>
<script
